  ...
  return (
    <div className="pb-20 px-4 dark:bg-[radial-gradient(circle,_rgba(36,36,36,1)_0%,_rgba(26,26,26,1)_100%)] flex items-center justify-center flex-col">
      ...
      <div className="flex items-center justify-center gap-4">
        {" "}
        <Link to={'/auth/signup'} className="flex dark:bg-white  bg-black capitalize text-white dark:text-black  px-4 py-2 cursor-pointer rounded-full shadow-white items-center justify-center gap-3">
          Start writing today{" "}
